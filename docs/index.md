...
| Print a list of monitors. | `-span [h]` |
| Set monitor spanning to use the override-redirect attribute in the session window. | `-span [o]<ica-file>` |
| Set monitor spanning to create a session covering a specified monitor. | `-span [a|mon1[,mon2[,mon3,mon4]]]<ica-file>`|
